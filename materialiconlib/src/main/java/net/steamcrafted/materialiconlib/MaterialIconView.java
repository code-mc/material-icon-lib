...
public class MaterialIconView extends ImageView
{
    ...
    {
        if (MaterialIconValues.iconExists(name))
            setIcon(MaterialIconValues.getValueByName(name));
        else
            setIcon(MaterialIconValues.getValueByName("close_box"));
    }
