...
public class MaterialDrawableBuilder
{
    ...
    public MaterialDrawableBuilder setIcon(String name)
    {
        if (MaterialIconValues.iconExists(name))
            icon = MaterialIconValues.getValueByName(name);
        else
            icon = MaterialIconValues.getValueByName("close_box");
        return this;
    }
    ...
    public MaterialDrawableBuilder setIconByName(String iconname)
    {

        setIcon(MaterialIconValues.getValueByName(iconname));
        return this;
    }
